...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Avtar field in *Biography → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.default.primary.avtar
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  avtar: prismic.ImageField<never>;
}
...
export interface TechlistSliceDefaultPrimaryGroupItem {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: techlist.default.primary.group[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: techlist.default.primary.group[].tech_color
...
export interface TechlistSliceDefaultPrimary {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: techlist.default.primary.group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
